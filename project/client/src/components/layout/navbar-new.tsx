...
export default function Navbar() {
  ...
  return (
    ...
    >
          ...
          <nav className="hidden md:flex items-center space-x-6">
            {navItems.map((item) => {
              ...
              return (
                <button 
                  key={item.label}
                  className="flex flex-col items-center justify-center text-gray-700 dark:text-gray-300 hover:text-primary"
            ...
            <DropdownMenu>
              <DropdownMenuTrigger asChild>
                <button className="flex flex-col items-center justify-center text-gray-700 dark:text-gray-300 hover:text-primary" title="Categorias">
      ...
      {/* Mobile menu */}
      {mobileMenuOpen && (
        <div className="md:hidden backdrop-blur-xl bg-white/95 dark:bg-gray-900/95 px-4 py-4 shadow-lg border-t border-gray-100 dark:border-gray-800">
          <div className="flex flex-col space-y-4">
            <div className="grid grid-cols-5 gap-4">
              {navItems.map((item) => {
                ...
                return (
                  <button 
                    key={item.label}
                    className="flex flex-col items-center justify-center text-gray-700 dark:text-gray-300 hover:text-primary p-2"
                    onClick={() => {
                      navigate(item.path);
            ...
            <div className="border-t border-gray-100 dark:border-gray-800 pt-3">
              <span className="text-gray-700 dark:text-gray-300 font-medium">Categorias</span>
            ...
            {user ? (
              <div className="border-t border-gray-100 dark:border-gray-800 pt-3 flex flex-col space-y-3">
                <Button 
                  variant="outline" 
                  onClick={() => {
                ...
                <span 
                  className="text-gray-700 dark:text-gray-300 hover:text-primary flex items-center py-1"
                  onClick={() => {
                    navigate("/profile");
                    setMobileMenuOpen(false);
                  }}
                ...
                <Button 
                  variant="outline"
                  className="flex items-center justify-center border-rose-500 text-rose-500 hover:bg-rose-50 dark:hover:bg-rose-950/30"
                  onClick={() => {
                    handleLogout();
                    setMobileMenuOpen(false);
                  }}
